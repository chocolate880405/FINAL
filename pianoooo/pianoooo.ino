...
void ledall[]{led_1,led_2,led_3,led_4,led_5,led_6,led_7};
...
void setup(void) {
  ...
  digitalWrite(led_all[], 0);
  digitalWrite(led_all[], 1);
  digitalWrite(led_all[], 0);
...
void loop(void) {
   ...
   if(state==1){
      ...
      if(flag==1){
          ...
          if(i==42)flag=0;
          if(CONTROL_state==1) {
            tone(8,star_melody[i] ,starBeat[i]*333);
            flag=1;i++;
   ...
   if(state==2){
      ...
      if(flag==1){
          ...
          if(CONTROL_state==1 && i<47) {
            tone(8, bee_melody[i],beeBeat[i]*333);
            flag=1;i++;
